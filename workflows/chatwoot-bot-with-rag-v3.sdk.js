...
const chatwootHandoffPublicReply = node({
  ...
  "parameters": {
    ...
    "sendBody": true,
    "specifyBody": "json",
    "jsonBody": "={{ JSON.stringify({ content: $('Prepare LLM Guided State').first().json.publicAnswer || 'Thanks for reaching out. This looks outside what I can confidently help with as ProGolf support, so I am going to connect you with our team and we will get back to you.', message_type: 'outgoing', private: false }) }}",
    "options": {
      "timeout": 30000
    }
  },
